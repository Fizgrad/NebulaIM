...
grpc::Status RelationServiceImpl::SendFriendRequest(grpc::ServerContext*, const proto::SendFriendRequestRequest* request, proto::SendFriendRequestResponse* response) {
...
grpc::Status RelationServiceImpl::AcceptFriendRequest(grpc::ServerContext*, const proto::AcceptFriendRequestRequest* request, proto::CommonResponse* response) {
...
grpc::Status RelationServiceImpl::RejectFriendRequest(grpc::ServerContext*, const proto::RejectFriendRequestRequest* request, proto::CommonResponse* response) {
...
grpc::Status RelationServiceImpl::ListFriendRequests(grpc::ServerContext*, const proto::ListFriendRequestsRequest* request, proto::ListFriendRequestsResponse* response) {
