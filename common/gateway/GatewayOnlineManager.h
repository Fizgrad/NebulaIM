...
public:
    ...
    bool setOnline(uint64_t user_id, const std::string& connection_id);
    bool setOnline(uint64_t user_id, const std::string& device_id, const std::string& connection_id);
    bool refreshOnline(uint64_t user_id, const std::string& connection_id);
    bool refreshOnline(uint64_t user_id, const std::string& device_id, const std::string& connection_id);
    bool setOffline(uint64_t user_id, const std::string& connection_id);
